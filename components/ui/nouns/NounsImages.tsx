...
const NounsImages = ({ cards, handleCarousel, id, activeCard }) => {
  ...
  return (
    ...
    >
      <div
        className={`h-[395px] cursor-pointer w-[265px] md:h-[590px] md:w-[400px] absolute img-carousel-${id}-1 z-0`}
      ...
      {cards.length > 1 && (
        <div
          className={`"h-[245px] cursor-pointer w-[245px] md:h-[345px] md:w-[345px] absolute left-[280px] md:left-[410px] img-carousel-${id}-2 z-10`}
